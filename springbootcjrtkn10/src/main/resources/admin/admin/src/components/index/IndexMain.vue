<template>
	<div style="height: 100%;">
		<el-main :style='"horizontal" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0","position":"relative","background":"#E2E2E2","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative","background":"#E2E2E2"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px rgba(0, 0, 0, .3)","padding":"0 20px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"center","background":"url(http://codegen.caihongy.cn/20241012/538215fc5b874aaca5d9c31ff8562be9.webp) no-repeat center","gap":"20px","width":"100%","fontSize":"16px","position":"inherit","zIndex":"999","height":"100px"}'></index-header>
			...
			<template v-if="'horizontal' == 'horizontal'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :style='{"borderColor":"#efefef","background":"#FFF","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'></index-aside>
			  </template>
			</template>
			
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0 20px","margin":"0","borderColor":"#3b6885","alignItems":"center","borderWidth":"0","background":"#fff","display":"flex","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' class="bread-crumbs"></bread-crumbs>
