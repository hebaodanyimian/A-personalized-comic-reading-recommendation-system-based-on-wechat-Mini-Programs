	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="作家姓名" prop="zuojiaxingming" >
					<el-input v-model="ruleForm.zuojiaxingming" placeholder="作家姓名" clearable  :readonly="ro.zuojiaxingming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="作家姓名" prop="zuojiaxingming" >
					<el-input v-model="ruleForm.zuojiaxingming" placeholder="作家姓名" readonly></el-input>
				</el-form-item>
	...
	export default {
		data() {
			...
			return {
				...
				rules: {
					zuojiazhanghao: [
						{ required: true, message: '作家账号不能为空', trigger: 'blur' },
					],
					zuojiaxingming: [
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='zuojiaxingming'){
							this.ruleForm.zuojiaxingming = obj[o];
							this.ro.zuojiaxingming = true;
							continue;
						}
						if(o=='mima'){
