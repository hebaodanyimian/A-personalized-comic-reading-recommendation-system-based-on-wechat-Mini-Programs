		...
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#f8f8f8","height":"auto"}'>
			...
			<view :style='{"alignContent":"flex-start","padding":"24rpx","margin":"0 auto","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20241110/41bb20fa3b804b2191d135a6f8653ad5.png) no-repeat center top / 100% auto","display":"flex","width":"100%","position":"relative","height":"auto","zIndex":"9"}' class="detail-content">
				...
				<view :style='{"padding":"0 20rpx","margin":"0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"left","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">漫画名称：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.manhuamingcheng}}</view>
				</view>
				<view :style='{"padding":"0 20rpx","margin":"0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"left","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">漫画类型：</view>
					<view :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text" >{{detail.manhualeixing}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"padding":"0 20rpx","margin":"0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"left","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>小说编号：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.xiaoshuobianhao}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0 20rpx","margin":"0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"left","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>作家账号：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.zuojiazhanghao}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0 20rpx","margin":"0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view :style='{"width":"100%","margin":"40rpx 0 24rpx 0","justifyContent":"center","display":"flex","order":"3"}'>
					<view :style='{"margin":"0","borderRadius":"20rpx 0 0 20rpx","color":"#fff","background":"#03b882","display":"flex","width":"50%","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					...
					<view :style='{"margin":"0","borderRadius":"20rpx","color":"#fff","background":"#03b882","display":"flex","width":"100%","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
						<view :style='{"padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"inherit","color":"inherit","textAlign":"right"}' class="lable">取消赞</view>
						<view :style='{"color":"inherit","lineHeight":"80rpx","fontSize":"inherit"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"margin":" 0 0 0 10rpx","lineHeight":"80rpx","fontSize":"inherit","color":"inherit"}' class="icon iconfont icon-zan10"></view>
					</view>
					<view :style='{"margin":"0","borderRadius":"0 20rpx 20rpx 0","color":"#666","background":"#b9cec9","display":"flex","width":"50%","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
					...
					<view :style='{"margin":"0","borderRadius":"20rpx","color":"#666","background":"#b9cec9","display":"flex","width":"100%","fontSize":"30rpx","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
				...
				<view class="detail-list-item rich" :style='{"padding":"0 0 0 20rpx","margin":"0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>漫画简介：</view>
					<view class="rich-text" :style='{"padding":"20rpx 24rpx 24rpx 0","margin":"0","lineHeight":"48rpx"}'>
						<rich-text :nodes="detail.manhuajianjie"></rich-text>
					</view>
				</view>
				<view :style='{"width":"100%","padding":"0","margin":"24rpx 0 24rpx 0","height":"auto","order":"8"}'>
					<view :style='{"padding":"0 0 0 80rpx","margin":"0 0 40rpx","borderColor":"#23baf7","color":"#000","textAlign":"left","background":"url(http://codegen.caihongy.cn/20241110/8dff7d1201304c20b53f3530844a8261.png) no-repeat left center","borderWidth":"0 0 0 0px","width":"100%","fontSize":"44rpx","position":"relative","borderStyle":"solid","fontWeight":"600"}'>正文卷·共{{toChinesNum(freeChapterList.length)}}章 (免费阅读)</view>
					<view :style='{"width":"100%","padding":"0","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"border":"0px solid #23baf7","padding":"0 0 0 90rpx","margin":"0 0 40rpx","alignItems":"center","borderRadius":"8rpx","background":"url(http://codegen.caihongy.cn/20241110/3019e3a1502347969cda3011df7c71d2.png) no-repeat left center / auto 100%,linear-gradient(90deg, rgba(40,193,148,1) 0%, rgba(40,193,148,1) 25%, rgba(243,245,249,1) 100%)","display":"flex","width":"48%","height":"80rpx"}' @click="chapterClick(item)" v-for="(item,index) in freeChapterList" :key="index">
							<text :style='{"width":"100%","fontSize":"28rpx","overflow":"hidden","whiteSpace":"nowrap","textOverflow":"ellipsis","color":"#333"}'>{{item.chaptertitle}}</text>
						</view>
					</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0","margin":"40rpx auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"20"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#03b882","borderRadius":"8rpx","background":"#c8dbd5","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' @tap="chapterClick(freeChapterList[0])">免费试读</button>
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#03b882","borderRadius":"8rpx","background":"#c8dbd5","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('manhuaxiaoshuo','私聊')" @tap="chatClick">联系TA</button>
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#03b882","borderRadius":"8rpx","background":"#c8dbd5","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('manhuaxiaoshuo','私聊')" @tap="chatClick">联系TA</button>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			this.getThumbsup();
			let cleanType = uni.getStorageSync('discussmanhuaxiaoshuoCleanType')
			if(cleanType){
				uni.removeStorageSync('discussmanhuaxiaoshuoCleanType')
				this.mescroll.num = 1
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('manhuaxiaoshuo', this.id);
				let reg=new RegExp('http://localhost:8080/springbootcjrtkn10/upload','g')//g代表全部
				if(res.data.manhuajianjie){
					res.data.manhuajianjie = res.data.manhuajianjie.replace(reg, this.$base.url + 'upload');
				}
				this.detail = res.data;
				this.title = this.detail.manhuamingcheng
			}
		},
		destroyed: function() {
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','manhuaxiaoshuo');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('manhuaxiaoshuo',_this.detail)
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.add('storeup', {
								userid: _this.user.id,
								name: _this.detail.manhuamingcheng,
								inteltype: _this.detail.manhualeixing,
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','manhuaxiaoshuo');
			...
			async init(type=1){
				...
				let res = await this.$api.info('manhuaxiaoshuo', this.id);
				let reg=new RegExp('http://localhost:8080/springbootcjrtkn10/upload','g')//g代表全部
				res.data.manhuajianjie = res.data.manhuajianjie.replace(reg, this.$base.url + 'upload');
				this.detail = res.data;
				...
				//修改富文本的图片样式
				this.detail.manhuajianjie = this.detail.manhuajianjie.replace(/img src/gi,"img style=\"width:100%;\" src");
				...
				if(type==2){
					...
					await this.$api.update('manhuaxiaoshuo',this.detail)
				}
			},
			...
			async upCallback(mescroll) {
				if(uni.getStorageSync("appUserid")){
					let res = await this.$api.list('discussmanhuaxiaoshuo', {
						page: mescroll.num,
						limit: 10,
			...
			async comzanClick(row){
				...
				if(!this.comzanChange(row)){
					...
					await this.$api.update('discussmanhuaxiaoshuo',row)
					this.$utils.msg('点赞成功');
				}else {
					row.thumbsupnum--
					let arr = String(row.tuserids).split(',')
			...
			async onCommentTap() {
				...
				let res = {}
				this.$utils.jump(`../discussmanhuaxiaoshuo/add-or-update?refid=${this.id}` )
			},
			delClick(id){
				let that = this
				uni.showModal({
					...
					async success(res) {
						if(res.confirm){
							await that.$api.del('discussmanhuaxiaoshuo',JSON.stringify([id]))
							that.$utils.msg('删除成功')
							that.detail.discussnum--
							await that.$api.update('manhuaxiaoshuo',that.detail)
							setTimeout(()=>{
