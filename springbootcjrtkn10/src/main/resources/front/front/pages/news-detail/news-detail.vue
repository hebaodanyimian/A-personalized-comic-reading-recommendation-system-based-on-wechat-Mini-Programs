<template>
	<view :style='{"minHeight":"100vh","width":"100%","padding":"0px","position":"relative","background":"#f3f5f9","height":"auto"}'>
		...
		<view :style='{"padding":"20rpx","margin":"0px auto","background":"#fff","justifyContent":"space-between","display":"flex","order":"4"}'>
		  <view :style='{"padding":"16rpx 50rpx","borderRadius":"40rpx","background":"#ecfaec","display":"flex"}' @click="likeClick">
		  ...
		  <view :style='{"padding":"16rpx 50rpx","borderRadius":"40rpx","background":"#ecfaec","display":"flex"}' @click="collectClick">
		...
		<div :style='{"padding":"0 0 40rpx","margin":"0px auto","borderRadius":"0px","background":"#fff","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
		  <div @click="prepDetailClick" :style='{"padding":"0 20rpx","margin":"0 40rpx 0 0","color":"#ffff","borderRadius":"20rpx","textAlign":"center","background":"#03b882","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>上一篇：prev</div>
		  <div @click="nextDetailClick" :style='{"padding":"0 20rpx","color":"#fff","borderRadius":"20rpx","textAlign":"center","background":"#03b882","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>下一篇：next</div>
		</div>
		

		<!-- 热门 -->
		<view class="hot" :style='{"width":"calc(100% - 48rpx)","margin":"40rpx auto 0","background":"none","height":"auto"}'>
		  ...
		  <view :style='{"padding":"0","borderRadius":"20rpx","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in hotList" :key="index" :style='{"width":"48%","padding":"0","margin":"0 0 40rpx","borderRadius":"0","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
			  <image :style='{"margin":"0","objectFit":"cover","borderRadius":"0px","display":"block","width":"150rpx","float":"left","height":"180rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
		      <view :style='{"padding":"0 8rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#03b882","width":"calc(100% - 160rpx)","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","float":"right"}'>{{ item.title }}</view>
		...
		<!-- 推荐 -->
		<view class="recommend" :style='{"width":"calc(100% - 48rpx)","margin":"0px auto 0","background":"none","height":"auto"}'>
		  <view :style='{"padding":"0 0 0 80rpx","margin":"0 0 40rpx","borderColor":"#23baf7","color":"#000","textAlign":"left","background":"url(http://codegen.caihongy.cn/20241110/8dff7d1201304c20b53f3530844a8261.png) no-repeat left center","borderWidth":"0 0 0 0px","width":"100%","fontSize":"44rpx","position":"relative","borderStyle":"solid","fontWeight":"600"}'>推荐信息</view>
		  <view :style='{"padding":"0","borderRadius":"20rpx","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <view v-for="(item,index) in recommendList" :key="index" :style='{"width":"48%","padding":"0","margin":"0 0 40rpx","borderRadius":"0","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
		      <image :style='{"margin":"0","objectFit":"cover","borderRadius":"0px","display":"block","width":"150rpx","float":"left","height":"180rpx"}' mode="aspectFill" :src="baseUrl + item.picture"></image>
			  <view :style='{"padding":"0 8rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#03b882","width":"calc(100% - 160rpx)","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","float":"right"}'>{{ item.title }}</view>
		      <view :style='{"padding":"0 8rpx","color":"#999","textAlign":"left","width":"calc(100% - 160rpx)","lineHeight":"48rpx","fontSize":"26rpx","float":"right"}'>{{ item.addtime }}</view>
		    </view>
